...
import { MoreHorizontal, Plus, Loader2, Store, Pencil, Trash2 } from 'lucide-react';
            ...
            {loading ? (
              ...
              branches.map((branch) => (
                <TableRow key={branch.id}>
                  <TableCell className="font-medium flex items-center gap-2"><Store className="h-4 w-4 text-muted-foreground" /> {branch.name}</TableCell>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem asChild>
                          <Link to={`/branches/${branch.id}/edit`} state={{ branch }} className="cursor-pointer">
